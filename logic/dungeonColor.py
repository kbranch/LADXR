...
class DungeonColor:
    def __init__(self, options, world_setup, r):
        ...
        miniboss_room1 = Location("D0 Miniboss Room 1", dungeon=0).connect(room2, FOUND(KEY0, 3), id="lj")
        ...
        miniboss_room2 = Location("D0 Miniboss Room 2", dungeon=0).connect(room2, FOUND(KEY0, 2), id="ll")
        ...
        room6 = Location("D0 Room Before Boss", dungeon=0).connect(room5, FOUND(KEY0, 3), id="lr") # room with switch and nightmare door
