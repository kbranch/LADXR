...
class Dungeon8:
    def __init__(self, options, world_setup, r, *, back_entrance_heartpiece=0x000):
        ...
        lower_center = Location("D8 After Lava Keyblock", dungeon=8).connect(entrance_up, FOUND(KEY8, 1), id="ju")
        hidden_arrow_room = Location("hidden_arrow_room", dungeon=8).connect(lower_center, FOUND(KEY8, 2), id="jv")
        if options.owlstatues == "both" or options.owlstatues == "dungeon":
        ...
        middle_center_2 = Location("D8 Dark Center", dungeon=8).connect(middle_center_1, FOUND(KEY8, 4), id="k0")
        middle_center_3 = Location("D8 Dark West", dungeon=8).connect(middle_center_2, AND(r.enemy_requirements["SNAKE"], FOUND(KEY8, 3)), id="k1")
        miniboss_entrance = Location("D8 Miniboss Stairs", dungeon=8).connect(middle_center_3, AND(HOOKSHOT, FOUND(KEY8, 7)), id="k2") # hookshot to get across to keyblock, 7 to fix keylock issues if keys are used on other keyblocks
        ...
        up_left = Location(dungeon=8).connect(upper_center, FOUND(KEY8, 4), id="k5")
        ...
        nightmare_key = Location(dungeon=8).add(DungeonChest(0x232)).connect(top_left_stairs, AND(FEATHER, r.miniboss_requirements["CUE_BALL"], FOUND(KEY8, 7)), id="kg")
