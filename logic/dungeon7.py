...
class Dungeon7:
    def __init__(self, options, world_setup, r):
        ...
        topright_pillar_area = Location("D7 Ball Room", dungeon=7).connect(entrance, FOUND(KEY7, 1), id="ik")
        ...
        bottomleftF2_area.connect(mirror_shield_chest, FOUND(KEY7, 3), one_way = True, id="iv") # reach mirror shield chest from hinox area by opening keyblock
